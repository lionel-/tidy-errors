...
- State problem with "must" and "can't" phrases
  ...
  - "Can't" when you know what is an invalid input
...
- "Vector" is not very relevant
- Let's mention the function argument
...
We take arguments so the checking function may be wrapped:
